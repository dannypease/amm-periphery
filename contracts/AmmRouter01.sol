...
import '@uniswap/v2-core/contracts/interfaces/IAmmFactory.sol';
...
contract AmmRouter01 is IAmmRouter01 {
    ...
    function removeLiquidityWithPermit(
        ...
        IAmmPair(pair).permit(msg.sender, address(this), value, deadline, v, r, s);
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, AmmLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return AmmLibrary.getAmountOut(amountOut, reserveIn, reserveOut);
    }
